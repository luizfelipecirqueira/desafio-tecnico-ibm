...
const ContextDescription = React.createContext<{ selectedBook?: Livro, handleSelectedBook?: React.Dispatch<React.SetStateAction<Livro>> | any }>({ selectedBook: { volumeInfo: { authors: [''], description: '', imageLinks: { thumbnail: '' }, industryIdentifiers: { identifier: '', type: '' }, publishedDate: '', publisher: '', subtitle: '', title: '' }, }});
